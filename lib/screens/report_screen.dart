      ...
      body: ListView(
        ...
        children: [
          ReportExpansion('အရင်း၊ အမြတ် နှင့် အရှုံး', Icons.account_balance, [
            {"subTile": 'အရင်း၊ အမြတ် နှင့် အရှုံး', "subVal": "cpl"},
            {"subTile": 'အရောင်း၀င်ငွေ စုစုပေါင်း'}
          ]),
          ReportExpansion('အရောင်း', Icons.shopping_cart, [
            {"subTile": 'အရောင်း စုစုပေါင်း'},
            {"subTile": 'ကုန်ပစ္စည်းအလိုက် အမြတ်စာရင်း'},
            {"subTile": 'ကုန်ပစ္စည်းအမျိုးအစားအလိုက် အမြတ်စာရင်း'},
            {"subTile": 'ကုန်ပစ္စည်းအလိုက် အရှုံးစာရင်း'},
            {"subTile": 'ကုန်ပစ္စည်းအမျိုးအစားအလိုက် အရှုံးစာရင်း'},
          ...
          ReportExpansion('ကုန်ပစ္စည်း', Icons.store_mall_directory,
              ...
              [
                ...
                {"subTile": 'အရေအတွက်နည်းနေသော ကုန်ပစ္စည်းစာရင်း'},
                {"subTile": 'အရေအတွက်များနေသော ကုန်ပစ္စည်းစာရင်း'},
                {"subTile": 'ပျက်စီးစာရင်း'},
                {"subTile": 'ပျောက်ဆုံးစာရင်း'},
                {"subTile": 'ဒိတ်လွန်နေသော ကုန်ပစ္စည်းစာရင်း'}
              ]),
        ],
      ),
    );
