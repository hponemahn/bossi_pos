...
class Stock extends StatelessWidget {
  ...
  Stock(this.seriesList, {this.animate});

  /// Creates a [BarChart] with sample data and no transition.
  factory Stock.withSampleData() {
    return new Stock(
      _createSampleData(),
  ...
  static List<charts.Series<OrdinalSales, String>> _createSampleData() {
    final data = [
      new OrdinalSales('Food', 5),
      new OrdinalSales('Drink', 25),
      new OrdinalSales('Electronic', 100),
      new OrdinalSales('Clothing', 75),
    ];
